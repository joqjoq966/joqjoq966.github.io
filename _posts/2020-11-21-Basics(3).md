...
![resnet1](https://github.com/joqjoq966/joqjoq966.github.io/blob/master/img/Logistic Regression/odds.png?raw=true)    

- 로짓변환  
  오즈에 로그를 취한 함수로서 입력 값의 범위가 [0,1] 일 때 출력 값의 범위를 (-inf,inf)로 조정한다.  
  ![resnet1](https://github.com/joqjoq966/joqjoq966.github.io/blob/master/img/Logistic Regression/logit.png?raw=true) 
...
![resnet1](https://github.com/joqjoq966/joqjoq966.github.io/blob/master/img/Logistic Regression/logistic_fn.png?raw=true)   
