...
<center><img src="/img/Logistic Regression/odds.png" width="250" height="150"></center> 



- 로짓변환  
  오즈에 로그를 취한 함수로서 입력 값의 범위가 [0,1] 일 때 출력 값의 범위를 (-inf,inf)로 조정한다.  
<center><img src="/img/Logistic Regression/logit.png" width="250" height="150"></enter>
...
<center><img src="/img/Logistic Regression/logistic_fn.png" width="350" height="150"></center>
